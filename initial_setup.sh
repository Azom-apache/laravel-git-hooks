...
if [ "$HOOK" = 'Y' ]; then
    curl -fsL https://raw.githubusercontent.com/Azom-apache/laravel-git-hooks/main/post-receive >.git/hooks/post-receive
    ...
    curl -fsL https://raw.githubusercontent.com/Azom-apache/laravel-git-hooks/main/post-receive-shared >.git/hooks/post-receive
    chmod +x .git/hooks/post-receive
