...
```sh
curl https://raw.githubusercontent.com/Azom-apache/laravel-git-hooks/main/pre-commit > .git/hooks/pre-commit
```
...
```sh
curl https://raw.githubusercontent.com/Azom-apache/laravel-git-hooks/main/post-receive > .git/hooks/post-receive
```
...
```sh
curl -s https://raw.githubusercontent.com/Azom-apache/laravel-git-hooks/main/initial_setup.sh > tmp.sh && bash tmp.sh && rm tmp.sh
```
